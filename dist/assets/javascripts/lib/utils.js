...
const DAYS = 24 * HOURS;
const TIME = $countdown && $countdown.dataset.time ? $countdown.dataset.time : "";
const LAUNCHDATE = $countdown ? Date.parse(TIME) / 1000 : 0;
...
class Utils {
    files_ext; // Extension des fichiers
    /**
    *   Le constructeur
    *
    *   @return {void}
    ...
    **/
    Code(string) {
        const code_tag = document.querySelector('.postbody code');
        code_tag.innerHTML = `
